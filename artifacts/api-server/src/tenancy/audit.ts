...
export type AuditAction =
  ...
  | "DEVICE_SITE_CHANGED"
  | "DEVICE_REMOTE_COMMANDS_CHANGED"
  | "REMOTE_COMMANDS_GLOBAL_GATE_CHANGED"
  | "AGENT_ENROLLED"
  | "USER_CREATED"
  | "USER_UPDATED"
  | "USER_SUSPENDED"
  ...
  | "REMOTE_DESKTOP_REQUESTED" | "REMOTE_DESKTOP_AUTHORIZED" | "REMOTE_DESKTOP_SESSION_CREATED"
  | "REMOTE_DESKTOP_AGENT_CONNECTED" | "REMOTE_DESKTOP_STARTED" | "REMOTE_DESKTOP_DISCONNECTED"
  | "REMOTE_DESKTOP_EXPIRED" | "REMOTE_DESKTOP_FAILED" | "REMOTE_DESKTOP_TERMINATED"
  | "REMOTE_DESKTOP_DEVICE_ENABLED" | "REMOTE_DESKTOP_DEVICE_DISABLED";
