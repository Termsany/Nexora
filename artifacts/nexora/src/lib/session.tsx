...
const ORGANIZATION_CAPABILITIES: Record<OrganizationRole, string[]> = {
  ...
  ORGANIZATION_TECHNICIAN: ['organization:read', 'site:read', 'device:read', 'alert:read', 'software:read', 'inventory:read', 'alert:acknowledge', 'device:assign-site', 'enrollment-token:read', 'privileged_actions.request'],
  ORGANIZATION_ADMIN: ['organization:read', 'site:read', 'device:read', 'alert:read', 'software:read', 'inventory:read', 'alert:acknowledge', 'device:assign-site', 'site:manage', 'organization:update', 'enrollment-token:read', 'enrollment-token:manage', 'membership:read', 'membership:manage', 'notification:read', 'privileged_actions.request', 'privileged_actions.approve', 'remote_commands.manage', 'remote_commands.request', 'remote_desktop.connect'],
};

const PLATFORM_CAPABILITIES: Record<PlatformRole, string[]> = {
  PLATFORM_TECHNICIAN: ['organization:read', 'site:read', 'device:read', 'alert:read', 'software:read', 'inventory:read', 'alert:acknowledge', 'device:assign-site', 'notification:read', 'privileged_actions.request'],
  PLATFORM_ADMIN: ['organization:read', 'site:read', 'device:read', 'alert:read', 'software:read', 'inventory:read', 'alert:acknowledge', 'device:assign-site', 'organization:create', 'organization:update', 'site:manage', 'enrollment-token:read', 'enrollment-token:manage', 'membership:read', 'membership:manage', 'notification:read', 'notification:manage', 'privileged_actions.request', 'privileged_actions.approve', 'remote_commands.manage', 'remote_commands.request', 'remote_desktop.connect'],
  PLATFORM_SUPER_ADMIN: ['organization:read', 'site:read', 'device:read', 'alert:read', 'software:read', 'inventory:read', 'alert:acknowledge', 'device:assign-site', 'organization:create', 'organization:update', 'site:manage', 'enrollment-token:read', 'enrollment-token:manage', 'membership:read', 'membership:manage', 'notification:read', 'notification:manage', 'user:manage', 'privileged_actions.request', 'privileged_actions.approve', 'remote_commands.manage', 'remote_commands.request', 'remote_desktop.connect'],
};
