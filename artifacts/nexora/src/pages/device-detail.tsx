...
import { ArrowLeft, Bell, Boxes, ChevronRight, Cpu, Gauge, HardDrive, Network, RefreshCw, ServerCog, ShieldCheck, SquareActivity, UserRound, Wifi, Terminal, Power } from 'lucide-react';
